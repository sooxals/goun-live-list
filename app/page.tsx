...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  className="text-2xl md:text-3xl font-black text-gray-900 tracking-tight flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity select-none"
  title="처음 화면으로 이동"
>
  🎧 고운이 LIVE LIST
</h1>
